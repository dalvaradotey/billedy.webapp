      ...
      <nav className="fixed top-0 left-0 right-0 z-50 px-6 bg-white/95 dark:bg-slate-950/95 md:bg-white/90 md:dark:bg-slate-950/90 md:backdrop-blur-md border-b border-slate-200/50 dark:border-slate-800/50">
        <div className="max-w-6xl mx-auto py-4 flex items-center justify-between">
          ...
          <Drawer open={drawerOpen} onOpenChange={setDrawerOpen}>
            <DrawerTrigger className="group text-sm font-medium text-slate-700 dark:text-slate-200 bg-white dark:bg-slate-800 px-4 py-2 rounded-full border border-slate-200 dark:border-slate-700 hover:bg-slate-50 dark:hover:bg-slate-700 transition-colors flex items-center gap-1">
              Entrar
